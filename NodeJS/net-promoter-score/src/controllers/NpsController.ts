/*
	...
	Detratores => 0 - 6
	Passivos   => 7 - 8  =========> esses são descartados na fórmula e utilizados apenas na contagem total de participantes, ou seja, o número de respondentes
	Promotores => 9 - 10

	Fórmula: (Número de promotores - Número de detratores) / (Número de respondentes) X 100
*/
